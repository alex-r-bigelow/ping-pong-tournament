...
module.exports = __webpack_require__.p + "fc7aa04ca401796ccb01ce05a85c27ee.woff";
...
var SPREADSHEET_ID = '1xplN0dfgYruhL8IuG0T8TyrsBOXM-He9sQK075b-tR0';
...
function getTable(tableName) {
  return new Promise(function (resolve, reject) {
    _jquery2.default.ajax({
      ...
      url: BASE_URL + SPREADSHEET_ID + '/values/' + tableName + '!A1:ZZ1000000',
      data: {
        key: GOOGLE_API_KEY
      },
...
function appendToTable(tableName, rawValues) {
  return new Promise(function (resolve, reject) {
    _jquery2.default.ajax({
      method: 'POST',
      url: BASE_URL + SPREADSHEET_ID + '/values/' + tableName + ':append?key=' + GOOGLE_API_KEY,
      data: {
...
window.appendToTable = appendToTable;
