...
var transition_attr$1 = function(name, value) {
  var fullname = namespace(name), i = fullname === "transform" ? interpolateTransformSvg$1 : interpolate$1;
  return this.attrTween(name, typeof value === "function"
...
var request = function(url, callback) {
  var request,
      event = dispatch$4("beforesend", "progress", "load", "error"),
      mimeType,
      headers = map(),
...
var setFrame$2 = typeof requestAnimationFrame === "function" ? requestAnimationFrame : function(f) { setTimeout(f, 17); };
...
function sleep$2(time) {
  ...
  if (delay > 24) {
    ...
    if (!interval$4) clockLast$2 = clockNow$2, interval$4 = setInterval(poke$2, pokeDelay$2);
...
function cubehelix$6(h, s, l, opacity) {
...
define$2(Cubehelix$2, cubehelix$6, extend$2(Color$2, {
  brighter: function(k) {
    k = k == null ? brighter$2 : Math.pow(brighter$2, k);
...
function cubehelix$7(hue$$1) {
  return (function cubehelixGamma(y) {
    y = +y;

    function cubehelix$$1(start, end) {
      var h = hue$$1((start = cubehelix$6(start)).h, (end = cubehelix$6(end)).h),
...
cubehelix$7(hue$2);
var cubehelixLong$2 = cubehelix$7(nogamma$2);
...
cubehelixLong$2(cubehelix$6(300, 0.5, 0.0), cubehelix$6(-240, 0.5, 1.0));

var warm = cubehelixLong$2(cubehelix$6(-100, 0.75, 0.35), cubehelix$6(80, 1.50, 0.8));

var cool = cubehelixLong$2(cubehelix$6(260, 0.75, 0.35), cubehelix$6(80, 1.50, 0.8));

var rainbow = cubehelix$6();
